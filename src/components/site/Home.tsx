...
import footerDogFace from "@/assets/footer-dog-face.png.asset.json";
    ...
    <div className="[overflow-x:clip]">
      ...
      <div className="relative">
        ...
        <footer className="relative z-10 bg-forest pb-16 pt-8 text-primary-foreground">
          ...
          <Reveal delay={360} className="relative z-10 mx-auto mt-12 max-w-7xl px-6 pr-36 sm:pr-40 md:pr-44 lg:pr-48">
