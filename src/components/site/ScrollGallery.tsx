  ...
  return (
    ...
    >
      <img
        ...
        aria-hidden="true"
        loading="lazy"
        className="pointer-events-none absolute left-0 top-0 size-96 -translate-x-1/2 -translate-y-1/2 opacity-100 brightness-50 sepia hue-rotate-[160deg] saturate-200 animate-spin-slow lg:size-[28rem]"
      />
